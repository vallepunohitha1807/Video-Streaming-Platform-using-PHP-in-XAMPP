...
body {
    ...
    background-color: #2E1A47; /* Deep muted purple */
    color: #E6D6FF; /* Soft pastel lilac */
    margin: 0;
    padding: 0;
    display: flex;
}
...
.sidebar {
    width: 250px;
    height: 100vh;
    background-color: #3B254F; /* Dark muted violet */
    color: white;
    position: fixed;
    top: 0;
    left: 0;
...
.sidebar h2 {
    text-align: center;
    margin-bottom: 20px;
    color: #FFDAB9; /* Soft pastel lavender */
}
...
.sidebar a:hover {
    background-color: #4E2C66; /* Softened deep violet */
}

/* Logout Button - Pastel Style */
.sidebar .logout {
    background-color: #FFB6C1; /* Pastel pink */
    color: #4A2B52; /* Deep muted violet for contrast */
    margin-top: 20px;
    padding: 10px;
    border-radius: 8px;
...
.sidebar .logout:hover {
    background-color: #FF85A2; /* Slightly darker pastel pink */
...
.user-card {
    background: #3D2B56; /* Soft dark purple */
    border-radius: 10px;
...
.user-card img {
    ...
    height: 150px;
    object-fit: cover;
    border-bottom: 3px solid #FFDAB9; /* Muted pastel violet */
}

.user-card p {
    margin: 10px 0;
    font-size: 1.1rem;
    color: #FFDAB9; /* Pastel lilac */
    font-weight: bold;
}
...
<body>
    ...
    <div class="sidebar"><br><br><br>
        <img src="uploads/mahi.jpg" alt="Admin Profile" class="profile-pic">
        <h2>Admin Panel</h2>
